page 50202 "PRJ SuccessfulBrandChangeLog"
{
    Caption = 'Successful Brand Change Log';
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Administration;
    SourceTable = "PRJ LogProcedure";
    SourceTableView = where(ProceduresLogType = const(SuccessfulChangeBrandProcedures));
